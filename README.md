# ShyFox 3.8.1+shadowrz

Personal fork of ShyFox.

Current changes:
- Fix toolbar margins
- Fix hiding private browsing indicator for latest Firefox (135)
- Fix dialog size: https://github.com/Naezr/ShyFox/pull/219

For older changelogs see [original README](https://github.com/Naezr/ShyFox).
...
| (TODO) `shyfox.enable.context.menu.icons.native` | Context menu items get native icons | Depends on `shyfox.enable.context.menu.icons` |
...
* [Naezr](https://github.com/Naezr/ShyFox) - Thanks for creating this theme.
